        ...
        <div id="header_logo">
            ...
            <div id="menuzord" class="menuzord red">
				...
				<ul class="menuzord-menu">
							...
							<div class="megamenu-row">
								<div class="col12">
									<ul>
										...
										<li><a class="hvr-underline-from-center" href="../alumni_usbt.php">Alumni</a>	</li>
					...
					<li><a href="activities.php">Seminar/Activities</a></li>
					<li><a href="brains.php">BRAINS</a>	</li>
					<li><a href="/notices_usbt.php">Notice / Circular</a>	</li>
