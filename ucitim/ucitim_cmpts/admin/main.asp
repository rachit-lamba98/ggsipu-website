...
<% end if %>
<%
	dim myid,sqltemp,sqltemp1,i,collitem,vRecordToDelete
	
	i=0
	myid = Session("login_id")	
	
	sqltemp = "SELECT * FROM complaint"
...
<TR>
		    <TD WIDTH="100" ALIGN = "center"><B>From (ID)</B></TD>
  		    <TD WIDTH="100" ALIGN = "center"><B>Complaint ID</B></TD>
		    ...
		    <TD WIDTH="100" ALIGN = "center"><B>Assigned To</B></TD>
...
<TR>
		    ...
		    <TD WIDTH="100" ALIGN = "center"><FONT COLOR = "BLUE"><%=objrs("ASSIGNEDTO")%></FONT></TD>		    
		    ...
		    <TD WIDTH="100" ALIGN=center><INPUT TYPE = "submit" NAME ="cmpdel<%Response.Write objrs.Fields("COMPID")%>" value="Delete Comp"></TD>
</TR>
<% objrs.MoveNext %>
...
<TR>
		    ...
		    <TD WIDTH="100" ALIGN=center><INPUT TYPE = "submit" NAME ="msgdel<%Response.Write objrs1.Fields("SRNO")%>" value="Delete Msg"></TD>
</TR>
<% objrs1.MoveNext %>
