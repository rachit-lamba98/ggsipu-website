        ...
        <div id="header_logo">
            ...
            <div id="menuzord" class="menuzord red">
				...
				<ul class="menuzord-menu">
					<li><a href="javascript:void(0)">Dean</a>
						<div class="megamenu" style="border-radius: 15px;">
							<div class="megamenu-row">
								<div class="col12">
									<ul>
										<li><a class="hvr-underline-from-center" href="Dean.php">Dean</a></li>
										<li><a class="hvr-underline-from-center" href="#">Past Deans</a></li>
					...
					<li><a href="javascript:void(0)">Committees</a>
						<div class="megamenu" style="border-radius: 15px;">
							<div class="megamenu-row">
								<div class="col12">
									<ul>
										<li><a class="hvr-underline-from-center" href="bosusmphs.pdf">Board of Studies</a></li>
										<li><a class="hvr-underline-from-center" href="srcusmphs.pdf">School Research Committee</a></li>
										<li><a class="hvr-underline-from-center" href="#">Academic Council</a></li>
					...
					<li><a href="#">Medical Science</a>	
					<li><a href="#">AYUSH</a>	
					<li><a href="#">Nursing</a>	
					<li><a href="#">Paramedical</a>	
					<li><a href="#">Notices</a>	
					</li>
					<!--li><a href="javascript:void(0)">Dean</a>
						<div class="megamenu" style="border-radius: 15px;">
							<div class="megamenu-row">
								<div class="col12">
									<ul>
										<li><a class="hvr-underline-from-center" href="Professor.php">Dean</a></li>
										<li><a class="hvr-underline-from-center" href="#">Past Deans</a></li>
