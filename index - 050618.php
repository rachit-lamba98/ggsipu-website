   ...
   <div style="width:70%;float:left;display:inline;">
    ...
    <div id="_visitors" style="width:10%;display:inline;">
     ...
     <!-- Start Sideblock: Image and Text -->
            ...
            <div class="imageTextTtle" style="background:white;color:#0955a0; margin-top:0; margin-bottom:0;"><h5 style="height:30px" >Centralized Placement</h5></div>
        ...
        <div class="imageTextText"><br>
                <div ><a href="career_plcmnt.php"><b>&nbsp;&nbsp;  Centralized Career Guidance and Placement Cell (CCGPC)</b></a></div><br>
