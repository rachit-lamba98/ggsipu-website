        ...
        <div id="header_logo">
            ...
            <div id="menuzord" class="menuzord red">
				...
				<ul class="menuzord-menu">
							...
							<div class="megamenu-row">
								<div class="col12">
									<ul>
										...
										<li><a class="hvr-underline-from-center" href="Programmes.php">Scheme/Syllabus</a></li>
										...
										<li><a class="hvr-underline-from-center" href="Research.php">Research</a></li>
                    ...
                    <li><a href="/alumni_usbas.php">Alumni</a>
                    </li>
					...
					<li><a href="/notices_usbas.php">Notice/Circular</a>
