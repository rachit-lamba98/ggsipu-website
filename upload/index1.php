  ...
  ga('send', 'pageview');
    ...
    <form action="index.php" method="POST">
		...
		<option value="academic_affairss">Academic Affairs</option>
            ...
            <option value="phd_admission">Ph.D 2017 Admissions</option>
            ...
            <option value="rnc_notices">RNC Notices</option>
			...
			<option value="notice_usict">Notice-USICT</option>
          </select>
          ...
          <textarea id="link" name="link" cols="80" rows="2">/pubinfo/</textarea>
