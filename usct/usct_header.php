        ...
        <div id="header_logo">
            ...
            <div id="menuzord" class="menuzord red">
				...
				<ul class="menuzord-menu">
					...
					<li><a href="javascript:void(0)">Students</a>
						<div class="megamenu" style="border-radius: 15px;">
							<div class="megamenu-row">
								<div class="col12">
									<ul>
										<li><a class="hvr-underline-from-center" href="reactmain.pdf">REACT</a></li>
										<li><a class="hvr-underline-from-center" href="iichemain.pdf">IIChE Chapter</a></li>
					...
					<li><a href="/notices_usct.php">Notices</a>
