...
alwaysvisible=1;
style=menuStyle;
aI("image=http://img.milonic.com/home.gif;offfunction=item_off();onfunction=item_on();text=Home;url=http://www.milonic.com/;");
aI("offfunction=item_off();onfunction=item_on();showmenu=Samples;text=Menu Samples;");
aI("offfunction=item_off();onfunction=item_on();showmenu=Milonic;text=Milonic;");
aI("offfunction=item_off();onfunction=item_on();showmenu=Partners;text=Partners;");
aI("offfunction=item_off();onfunction=item_on();showmenu=Links;text=Links;");
aI("offfunction=item_off();onfunction=item_on();showmenu=My Milonic;text=My Milonic;");
}
...
style=menuStyle;
aI("offfunction=item_off();onfunction=item_on();text=Product Purchasing Page;url=http://www.milonic.com/cbuy.php;");
aI("offfunction=item_off();onfunction=item_on();text=Contact Us;url=http://www.milonic.com/contactus.php;");
aI("offfunction=item_off();onfunction=item_on();text=Newsletter Subscription;url=http://www.milonic.com/newsletter.php;");
aI("offfunction=item_off();onfunction=item_on();text=FAQ;url=http://www.milonic.com/menufaq.php;");
aI("offfunction=item_off();onfunction=item_on();text=Discussion Forum;url=http://www.milonic.com/forum/;");
aI("offfunction=item_off();onfunction=item_on();text=Software License Agreement;url=http://www.milonic.com/license.php;");
aI("offfunction=item_off();onfunction=item_on();text=Privacy Policy;url=http://www.milonic.com/privacy.php;");
}

with(milonic=new menuname("Partners")){
style=menuStyle;
aI("offfunction=item_off();onfunction=item_on();text=(aq) Web Hosting;url=http://www.a-q.co.uk/;");
aI("offfunction=item_off();onfunction=item_on();text=SMS 2 Email;url=http://www.sms2email.com/;");
aI("offfunction=item_off();onfunction=item_on();text=WebSmith;url=http://www.softidiom.com/;");
}

with(milonic=new menuname("Links")){
style=menuStyle;
aI("offfunction=item_off();onfunction=item_on();text=Apache Web Server;url=http://www.apache.org/;");
aI("offfunction=item_off();onfunction=item_on();text=MySQL Database Server;url=http://ww.mysql.com/;");
aI("offfunction=item_off();onfunction=item_on();text=PHP - Development;url=http://www.php.net/;");
aI("offfunction=item_off();onfunction=item_on();text=phpBB Web Forum System;url=http://www.phpbb.net/;");
aI("offfunction=item_off();onfunction=item_on();showmenu=Anti Spam;text=Anti Spam Tools;");
}

with(milonic=new menuname("Anti Spam")){
style=menuStyle;
aI("offfunction=item_off();onfunction=item_on();text=Spam Cop;url=http://www.spamcop.net/;");
aI("offfunction=item_off();onfunction=item_on();text=Mime Defang;url=http://www.mimedefang.org/;");
aI("offfunction=item_off();onfunction=item_on();text=Spam Assassin;url=http://www.spamassassin.org/;");
}

with(milonic=new menuname("My Milonic")){
style=menuStyle;
aI("offfunction=item_off();onfunction=item_on();text=Login;url=http://www.milonic.com/login.php;");
aI("offfunction=item_off();onfunction=item_on();text=Licenses;url=http://www.milonic.com/mylicenses.php;");
aI("offfunction=item_off();onfunction=item_on();text=Invoices;url=http://www.milonic.com/myinvoices;");
aI("offfunction=item_off();onfunction=item_on();text=Make Support Request;url=http://www.milonic.com/reqsupport.php;");
aI("offfunction=item_off();onfunction=item_on();text=View Support Requests;url=http://www.milonic.com/mysupport.php;");
aI("offfunction=item_off();onfunction=item_on();text=Your Details;url=http://www.milonic.com/mydetails.php;");
}
