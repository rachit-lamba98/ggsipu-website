...
alwaysvisible=1;
style=menuStyle;
aI("image=images/home.gif;offfunction=item_off();onfunction=item_on();text=Home;url=http://www.ipu.ac.in/;");
aI("offfunction=item_off();onfunction=item_on();showmenu=Samples;text=Administration;");
aI("offfunction=item_off();onfunction=item_on();showmenu=Milonic;text=Students;");
aI("offfunction=item_off();onfunction=item_on();showmenu=Partners;text=People;");
